      ...
      <div className="mt-1 sm:mt-5 w-full p-5 flex flex-col justify-center">
          ...
          <div className="w-full flex mt-5 gap-3">
            ...
            transition={{ type: "spring", stiffness: 400, damping: 17 }}
             onClick={() => window.open(source_code_link, "_blank")}  className="cursor-pointer bg-[#181823] p-3 flex gap-2 rounded-2xl px-5 text-[#E9F8F9] font-bold "
             >
            ...
            <motion.button
            whileTap={{ scale: 0.9 }}
            onClick={() => window.open(source_code_link, "_blank")} className="cursor-pointer bg-[#181823] p-3 flex gap-3 rounded-2xl px-5  text-[#E9F8F9] font-bold "
            >
  ...
  return (
    ...
    className="max-w-7xl mx-auto sm:px-16 px-6">
      ...
      <div className="text-right w-full mt-1 sm:mt-1 lg:mt-3">
        <h1 className="sm:text-[20px] text-[14px] text-[#E9F8F9] font-bold opacity-80 uppercase tracking-wider ">
          See More
        </h1>
      </div>
    </motion.section>
